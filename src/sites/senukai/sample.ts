...
export class SNKTesting {
    ...
    async test_e2e() {
        this.context.url = "https://www.senukai.lt/p/dulkiu-siurblys-sluota-karcher-fc-3/b92u";
    ...
    async test_ad() {
        let url =
            "https://www.senukai.lt/p/plyteles-akmens-mases-cerrad-climatic-5900423052912-1197-mm-x-597-mm/jxxo?cat=axs&index=1";
    ...
    async test_fetching_all_page() {
        this.context.url =
            "https://www.senukai.lt/paieska/?c3=Kompiuterinė+technika%2C+biuro+prekės%2F%2FNešiojami+kompiuteriai+ir+priedai%2F%2FNešiojami+kompiuteriai&c4=Kompiuterinė+technika%2C+biuro+prekės%2F%2FNešiojami+kompiuteriai+ir+priedai%2F%2FNešiojami+kompiuteriai%2F%2FLenovo+nešiojami+kompiuteriai&q=lenovo";
    ...
    async test_addItems() {
        this.context.url =
            "https://www.senukai.lt/paieska/?c3=Kompiuterinė+technika%2C+biuro+prekės%2F%2FNešiojami+kompiuteriai+ir+priedai%2F%2FNešiojami+kompiuteriai&c4=Kompiuterinė+technika%2C+biuro+prekės%2F%2FNešiojami+kompiuteriai+ir+priedai%2F%2FNešiojami+kompiuteriai%2F%2FLenovo+nešiojami+kompiuteriai&q=lenovo";
        this.context.url =
            "https://www.senukai.lt/paieska/?c3=Kompiuterinė+technika%2C+biuro+prekės%2F%2FNešiojami+kompiuteriai+ir+priedai%2F%2FNešiojami+kompiuteriai&c4=Kompiuterinė+technika%2C+biuro+prekės%2F%2FNešiojami+kompiuteriai+ir+priedai%2F%2FNešiojami+kompiuteriai%2F%2FLenovo+nešiojami+kompiuteriai&q=lenovo&o=432";
        // let { nextPageUrl, idUrls } = await fetchIds(this.context, this.sourceFunctions, undefined, undefined);
    ...
    async loadHtml({ filename, url, vehicleType }: { filename: string; url: string; vehicleType: string }) {
        ...
        // const processedItem = await processItem(parsedItem, this.context.source, vehicleType);
