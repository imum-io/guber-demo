...
export const measurementRegex = /[\d ]((?:mm$|cm$|m$|centimeter$|meter$|inch$|kg$|g$|gram$|kilogram$|kW$|W$|kiloWatt$|Watt$))$/i
...
export enum BucketNames {
    HTML = 'imum_html',
    BackUps = 'imum_backups',
    Cars = 'car_evaluations',
    RealEstates = 're_evaluations'
}

export enum imageBuckets {
    pharmacy = 'guber_pharmacy',
    property = 'guber_property',
}
